...
from diffusion_policy.module.transformer_for_action_diffusion import TransformerForActionDiffusion
from diffusion_policy.common.pytorch_util import dict_apply
from diffusion_policy.model.vision.transformer_obs_encoder import TransformerObsEncoder


class DiffusionTransformerTimmQATPolicy(BaseImagePolicy):
    def __init__(self,
            shape_meta: dict,
